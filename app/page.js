...
const page = () => {
    ...
    renderTask = mainTask.map((t , i) =>{
      return(
        <li key ={i} className='flex items-center justify-between mb-8'>
          ...
          <button onClick={()=>{
            completeHandler(i)
          }} className='bg-red-400 text-white px-4 py-2 rounded font-bold'>Complete</button>
        </li>
      )
    })
  }
  return (
    <>
    <h1 className='bg-black text-white text-2xl font-bold text-center p-5'>Shobhit's Todo List</h1>
